...
@app.on_callback_query(filters.regex("SonalimousAdmin") & ~BANNED_USERS)
async def Sonalimous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("SonaliPlaylists") & ~BANNED_USERS)
@languageCB
